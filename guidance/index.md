...
# Reusable project knowledge guidance

Load only the route that matches the current task.

## Start or adopt

- [Bootstrap a new project](workflows/bootstrap-new-project.md)
- [Adopt an existing project](workflows/adopt-existing-project.md)
- [Create a specialization](workflows/create-specialization.md)
...
- [Non-negotiable guardrails](guardrails/non-negotiable.md)
...
- [Profile authoring](reference/profile-authoring.md)
- [Runtime and distribution modes](reference/runtime-and-distribution.md)
- [Tool selection by architectural role](reference/tool-selection.md)
- [Versioning and upgrades](reference/versioning-and-upgrades.md)

This bundle is reusable guidance. The sibling `knowledge/` bundle describes the
implementation and maintenance of this toolkit itself and is not part of
project onboarding.
