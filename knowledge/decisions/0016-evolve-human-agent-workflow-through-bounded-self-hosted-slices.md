...
| Active delivery | B2/P1 and B2/P2 are both complete: P1 delivered the validated task envelope and deterministic current projection, and P2 was integrated through [PR #28](https://github.com/ktogias/gnostoa/pull/28) with [Issue #24](https://github.com/ktogias/gnostoa/issues/24) closed as completed. Post-effect reconciliation ([Issue #29](https://github.com/ktogias/gnostoa/issues/29)) and control-selection research ([Issue #31](https://github.com/ktogias/gnostoa/issues/31)) are also complete. The active item is [Issue #33](https://github.com/ktogias/gnostoa/issues/33): a bounded experiment with the selected C4-v0 readiness predicate, placed by [Decision 0017](0017-scope-the-readiness-predicate-experiment-to-gnostoa-self-hosting.md) in Gnostoa self-hosting and outside the public inherited surface. Provider state is authoritative for every Work Item lifecycle. Selection is not admission, an experimental result is not success, and success would not be adoption. |
...
| Recorded failed property | Critical workflow constraints are advisory rather than mechanically enforced. C4-v0, a deterministic read-only readiness predicate, is the selected bounded experiment against it, scoped by [Decision 0017](0017-scope-the-readiness-predicate-experiment-to-gnostoa-self-hosting.md) to Gnostoa self-hosting. Experimenting is not mitigating: increment 2 is **not activated** and no mitigation is adopted. |
