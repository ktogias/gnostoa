...
| Active delivery | None selected. B2/P1 and B2/P2 are both complete: P1 delivered the validated task envelope and deterministic current projection, and P2 was integrated through [PR #28](https://github.com/ktogias/gnostoa/pull/28) with [Issue #24](https://github.com/ktogias/gnostoa/issues/24) closed as completed. No successor B2 experiment is selected or active. |
