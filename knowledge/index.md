...
- [Separate reviewer capability state from staged review orchestration](decisions/0087-separate-reviewer-capability-state-from-staged-review-orchestration.md)
...
- [Reviewer capability, quota and orchestration baseline](assessments/reviewer-capability-quota-orchestration-baseline.md)
