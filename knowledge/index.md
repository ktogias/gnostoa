...
- [Establish v0.1.1 as a source-only patch release identity](decisions/0038-establish-v0-1-1-as-the-first-source-only-patch-release-identity.md)
...
- [Add an input-only executable live entrypoint before R2A P2b-B2 activation](decisions/0074-add-input-only-live-entrypoint-to-r2a-p2b-b15-runtime.md)
