...
- [Evaluate portable review exchange and coordinator replacement](decisions/0063-evaluate-portable-review-exchange-and-coordinator-replacement.md)
- [Evaluate native structured review handoff](decisions/0064-evaluate-native-structured-review-handoff.md)
- [Run one bounded Gnostoa-self orientation snapshot](decisions/0065-run-a-bounded-gnostoa-self-orientation-snapshot.md)
- [Invalidate self-orientation on local Git subject drift](decisions/0066-invalidate-self-orientation-on-local-git-subject-drift.md)
...
- [Q0 reviewer qualification and independence baseline](assessments/10-q0-reviewer-qualification-baseline.md)
