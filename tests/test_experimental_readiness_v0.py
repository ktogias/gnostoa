...
NEGATIVE_CONTROLS = (
    Control(
        "P1-1",
        "git:ef62a008c92e5ad0d9a2c1cd2efe32f2387372f7",
        P1,
    ...
    Control(
        "P1-2",
        "git:ee61349bc2a91c65d8138ee8c3f5bf9cc4ae7f18",
        P1,
    ...
    Control(
        "P1-3",
        "git:3d19ec161244156488b113ed2f39114fddafc384",
        P1,
    ...
    Control(
        "P1-4",
        "git:638bfab670652f75250ffdb6161c00012476dbad",
        P1,
    ...
    Control(
        "P1-5",
        "git:24356e0467bd38ac09983ab9830dce2dffa23064",
        P1,
    ...
    Control(
        "P2-1",
        "git:96b2f8ca7a49742aa0915676be61c1823a5cf372",
        P2,
    ...
    Control(
        "P2-2",
        "git:37fa6e52438b7a00a01e463692dd32e4dc891b9e",
        P2,
    ...
    Control(
        "P2-3",
        "git:ada708ebc0f459be4eed13757cacf15c8da70137",
        P2,
...
POSITIVE_CONTROLS = (
    Control(
        "POS-1",
        "git:31266ff96f5beea31f4926e15f6e29611af34194",
        P1,
    ...
    Control(
        "POS-2",
        "git:73909762661bdf81fc3c2c35ad553d13fa25acd1",
        P1,
    ...
    Control(
        "POS-3",
        "git:0e336b49c16d2b8bbef7b9435b683d5df52755a7",
        P2,
    ...
    Control(
        "POS-4",
        "git:ac95c558d70b119df4d635e6531334bf83bab1a9",
        P2,
    ...
    for commit in commits:
        probe = subprocess.run(
            [
                ...
                "cat-file",
                "-e",
                f"{commit.removeprefix('git:')}^{{commit}}",
            ],
            capture_output=True,
            check=False,
        )
