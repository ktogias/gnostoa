...
def _case_variants(
    ...
    if case_id == "R08":
        ...
        collection["evidence_set"]["sources"][0]["observed_at"] = (
        ...
        qualification["qualification_snapshot"]["observed_at"] = (
            "2026-09-12T00:11:00Z"
        )
        ...
        missing_marker["acquired_judge"]["source_revision"] = (
            missing_marker["authority"]["expected_judge"]["source_revision"]
        )
        ...
        for status in ("RATE_LIMITED", "UNAVAILABLE", "ERROR"):
            ...
            variants.append(
                (f"required_{status.lower()}", candidate, policy_document)
            )
    elif case_id == "R18":
        ...
        expired["qualification_snapshot"]["observed_at"] = (
